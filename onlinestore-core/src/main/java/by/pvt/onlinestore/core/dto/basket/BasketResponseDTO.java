...
public class BasketResponseDTO {
    ...
    public BasketResponseDTO(Long basketId, Long productId, Long orderId, int quantityOfGoods) {
    ...
    public boolean equals(Object o) {
        ...
        BasketResponseDTO that = (BasketResponseDTO) o;
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("BasketResponseDTO{");
